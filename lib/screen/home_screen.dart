...
final feedDataList = [
  ...
  FeedData(userName: 'User2', likeCount: 24, content: '내일 운동가기 싫다.'),
  FeedData(userName: 'User3', likeCount: 82, content: '오늘 아침 안먹음.'),
  FeedData(userName: 'User4', likeCount: 92, content: '오늘 저녁은 머먹지.'),
  FeedData(userName: 'User5', likeCount: 43, content: '공부하기 싫다.'),
  FeedData(userName: 'User6', likeCount: 72, content: '플러터 공부중.'),
  FeedData(userName: 'User7', likeCount: 3, content: '인스타 클론코딩.'),
  FeedData(userName: 'User8', likeCount: 0, content: '운동 언제가지.'),
  FeedData(userName: 'User9', likeCount: 35, content: '화산귀한 결제할까.'),
];
